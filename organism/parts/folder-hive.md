...
order: 1
span: 2
role: "A folder of markdown with git underneath: `HIVE.md`, `.gitattributes`, `members/`, `requests/`, `shared/`, `former/`, and no owner inside"
...
- `HIVE.md` holds its rules, including how many approvals an admission, a publication or a rules change needs. New Hives start at 2.
