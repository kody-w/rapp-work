...
- In the draft convention, each repository, a station, keeps its own member space: its card `.rapp/member.md` and what it shares under `.rapp/shared/`, changed by its own commits. Eight stations publish their card on their default branch, merged on 2026-09-26: `kody-w/RAR#1117`, `kody-w/rapp-1#44`, `kody-w/rapp-model-hive#3`, `kody-w/hive-hub-mcp#2`, `kody-w/hive-hub-join#2`, `kody-w/rapp-hive-hub-join#2`, `kody-w/rapp-drift-lint#3` and `kody-w/lisppy#2`. More are proposed in open pull requests, such as `kody-w/rapp-work#4`, and the installer's rides in `kody-w/rapp-installer#48`, which only the owner merges.
